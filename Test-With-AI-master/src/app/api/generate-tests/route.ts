...
const testCasesSchema = z.object({
  test_cases: z.array(
    z.object({
      ...
      // z.string() avoids enum constraint at API level; casing is normalised after
      risk_level: z.string().describe("Risk level: must be exactly one of 'High', 'Medium', or 'Low'"),
...
const qualityScoreSchema = z.object({
  quality_score: z.object({
    ...
    missing_scenarios: z.array(z.string()).describe("List of missing test coverage areas"),
  ...
  }).describe("Quality evaluation of the generated test cases"),
});
